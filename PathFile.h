...
public:
	CPathFile();
	CPathFile(LPCTSTR szPath, BOOL bIsFolderPath = FALSE, BOOL bHasArguments = FALSE);
	CPathFile(DWORD dwSpecial);
	virtual ~CPathFile();
	...
	const CPathFile& operator = (LPCTSTR szPath);

	// Makes a copy of the object
	const CPathFile& operator = (CPathFile &ref);
